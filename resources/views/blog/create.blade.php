...
<div class="container-fluid">
    ...
    <form method="POST" id="createPostForm" action="/create/blog" enctype="multipart/form-data">
        @csrf
        <div class="form-group">
            <label for="judul">Judul Blog</label>
            <input type="text" class="form-control" id="judul" name="title" placeholder="Tulis judul blog kamu">
        </div>
        <div class="form-group">
